...
from .views import CourierLocationView, CourierOrdersAPIView, CurrentUserAPIView, UserOrdersAPIView
...
urlpatterns = [
    ...
    path('api/courier/orders/', CourierOrdersAPIView.as_view(), name='courier-orders'),
